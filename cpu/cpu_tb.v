module cpu_tb;
    ...
    // LB, LH, LBU, LHU:
    // instr 40, address 156 = 32'h00710E83 lb x29, 7(x2)
    // instr 41, address 160 = 32'h00611F03 lh x30, 6(x2)
    ...
    initial begin
        ...
        check(dut.regfile_inst.registers[29], 32'hFFFFFF80, "LB x29, 7(x2)");
